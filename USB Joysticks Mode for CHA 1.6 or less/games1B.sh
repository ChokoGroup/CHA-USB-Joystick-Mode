...
if [ -d /opt/usbjoysticksmode ]
then
  rm -rf /opt/usbjoysticksmode
  rm "/.choko/Activate USB Joysticks Mode."*
  echo "USB Joysticks Mode uninstalled."
else
  echo "USB Joysticks Mode not found."
fi
sleep 3
